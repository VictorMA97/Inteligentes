...
public class Maze { //crea el tablero
	...
	private void createAndShowGUI() {
        ...
        Hashtable<Integer, JLabel> labels = new Hashtable<Integer, JLabel>(); // barra de abajo que indica la velocidad de reproducción del video
		...
		solveButton.addActionListener(event -> {
			if (generated) {
				...
				JOptionPane.showMessageDialog(frame, "Espera a que termine de generarse la solución.");
			}
		});
